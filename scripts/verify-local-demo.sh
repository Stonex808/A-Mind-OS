...
SHELL_FEED="$ROOT_DIR/ui/shell/orchestrator-feed.json"
...
[[ -f "$SHELL_FEED" ]] || fail "missing shell orchestrator feed: $SHELL_FEED"
[[ -f "$DEMO_MEMORY_DIR/semantic_local/facts.json" ]] || fail "missing demo semantic memory facts.json"
[[ -f "$DEMO_MEMORY_DIR/semantic_local/concepts.json" ]] || fail "missing demo semantic memory concepts.json"
